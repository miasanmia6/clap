...
if __name__ == "__main__":
    ...
    parser.add_argument("--root", type=str, default="/root/autodl-tmp/clap/data/", help="path to dataset")
    ...
    parser.add_argument(
        "--config-file", type=str, default="configs/trainers/SGD_lr1e-1_B256_ep300.yaml", help="path to config file"
    )
    parser.add_argument(
        "--dataset-config-file",
        type=str,
